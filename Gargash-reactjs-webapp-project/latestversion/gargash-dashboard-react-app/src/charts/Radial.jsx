    ...
    <div className="nivo-special">
      <div className="dropdown-wrapper">
        <div className="dropdown">
          ...
          <Dropdown options={timeOptions} value={defaultOption} placeholder="Select an option" />
        </div>
        <div className="dropdown">
      ...
      <div className="legend">
        {chartData.map((series, key) => {
          return (
            <div key={key}>
              <ResponsiveContainer className="legend-item" width={60} height={60}>
                <PieChart>
                  <Pie
                    data={series.legend}
                    cx={20}
                    ...
                    {series.legend.map((entry, index) => (
                      <Cell key={`cell-${index}`} fill={index == 0 ? series.color : '#2C3551'} />
                    ))}
                  </Pie>
                </PieChart>
              </ResponsiveContainer>
